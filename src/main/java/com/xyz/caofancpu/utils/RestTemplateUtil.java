...
public class RestTemplateUtil {
     ...
     * @return
     */
    public ResultBody getParam(String url, Map<String, Object> paramMap) throws GlobalErrorInfoException {
     ...
     * @return
     */
    public ResultBody postBody(String url, Map<String, Object> paramMap) throws GlobalErrorInfoException {
