    ...
    e.AmRectangularChart = e.Class({
        inherits: e.AmCoordinateChart, construct: function (a) {
            ...
            if (!a.zbSet) {
                ...
                var c = a.color, d = a.fontSize, g = a.zoomOutButtonImageSize, h = a.zoomOutButtonImage.replace(/\.[a-z]*$/i, ""),
                    f = e.lang.zoomOutText || a.zoomOutText, l = a.zoomOutButtonColor, k = a.zoomOutButtonAlpha, m = a.zoomOutButtonFontSize,
            ...
            var a = this.dx, b = this.dy, c = this.marginLeftReal, d = this.marginTopReal, g = this.plotAreaWidth - 1, h = this.plotAreaHeight - 1,
                f = this.plotAreaFillColors, l = this.plotAreaFillAlphas, k = this.plotAreaBorderColor, m = this.plotAreaBorderAlpha;
        ...
        inherits: e.AmRectangularChart, construct: function (a) {
            ...
            if (b) {
                ...
                var c = ["value", "open", "low", "high", "close"], d = "value open low high close average sum count".split(" "), g = b.valueAxis,
                    h = this.chartData, f = b.numberFormatter;
                f || (f = this.nf);
...
(function () {
    ...
    e.Cuboid = e.Class({
        construct: function (a, b, c, d, e, h, f, l, k, m, p, n, r, w, y, u, q) {
            ...
            var a = this.set;
            a.clear();
            var b = this.container, c = b.chart, d = this.w, g = this.h, h = this.dx, f = this.dy, l = this.colors, k = this.alpha, m = this.bwidth,
                p = this.bcolor, n = this.balpha, r = this.gradientRotation, w = this.cornerRadius, y = this.dashLength, u = this.pattern,
                q = this.topRadius, E = this.bcn, v = l, t = l;
    ...
    e.CategoryAxis = e.Class({
        inherits: e.AxisBase, construct: function (a) {
            ...
            if (e.ifArray(a)) {
                ...
                var d = this.start, g = this.labelFrequency, h = 0, f = this.end - d + 1, l = this.gridCountR, k = this.showFirstLabel,
                    m = this.showLastLabel, p, n = "", n = e.extractPeriod(this.minPeriod), r = e.getPeriodDuration(n.period, n.count), w, y, u, q,
                    E = this.rotate;
