    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            if (a) {
                ...
                var g = h.width, h = h.height, k = this.width, l = this.height, m = 0, n = a.getBBox().height / 2, q = this.inside,
                    p = this.titleAlign;
            ...
            var a, b = this.chart, c = this.showFirstLabel, e = this.showLastLabel, h, f = "", g = d.extractPeriod(this.minPeriod),
                k = d.getPeriodDuration(g.period, g.count), l, m, n, q, p, t = this.firstDayOfWeek, r = this.boldPeriodBeginning;
...
(function () {
    ...
    d.RecAxis = d.Class({
        construct: function (a) {
            var b = a.chart, c = a.axisThickness, e = a.axisColor, h = a.axisAlpha, f = a.offset, g = a.dx, k = a.dy, l = a.x, m = a.y, n = a.height,
                q = a.width, p = b.container;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            this.set = x;
            var u = a.axisThickness, A = a.axisColor, z = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, J = a.gridColor,
                H = a.dashLength, S = a.fillColor, O = a.fillAlpha, Q = a.labelsEnabled;
            n = a.labelRotationR;
            var ga = a.counter, I = a.inside, aa = a.labelOffset, va = a.dx, ma = a.dy, Oa = a.orientation, Z = a.position, da = a.previousCoord,
                X = a.height, Aa = a.width, ea = a.offset, fa, Ba;
...
(function () {
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            var a = this.div;
            if (a) {
                var b = this.chartDiv, c = a.offsetWidth, e = a.offsetHeight, h = this.container, c = d.removePx(d.getStyle(a, "padding-left")),
                    e = d.removePx(d.getStyle(a, "padding-right")), f = d.removePx(d.getStyle(a, "padding-top")),
                    g = d.removePx(d.getStyle(a, "padding-bottom"));
                isNaN(c);
                isNaN(e);
                isNaN(f);
                isNaN(g);
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            for (d = this.start; d <= this.end; d++) {
                var f = this.data[d].axes[c.id].graphs[this.id], g = f.values, k = g.x, l = g.y, g = c.getCoordinate(k, this.noRounding),
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    ...
                    c.push(t);
                    if (!isNaN(p)) {
                        var v = this.valueAxis.getCoordinate(p, this.noRounding) - this.height, v = v * this.valueAxis.rMultiplier,
                            y = v * Math.sin(r / 180 * Math.PI), r = v * Math.cos(r / 180 * Math.PI);
                        e.push(y);
                        d.push(r);
                        isNaN(k) && (k = y);
                        isNaN(l) && (l = r)
            ...
            if (e) {
                var f = this.chart, g = this.valueAxis, k = "middle", l = !1, m = this.labelPosition, n = e.getBBox(), q = this.chart.rotate,
                    p = a.isNegative, t = this.fontSize;
            ...
            var a = this.chart, b = this.id, c = this.index, e = this.data, h = this.chart.container, f = this.valueAxis, g = this.type,
                k = this.columnWidthReal, l = this.showBulletsAt;
            isNaN(this.columnWidth) || (k = this.columnWidth);
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate, r = this.columnCount,
                v = d.toCoordinate(this.cornerRadiusTop, k / 2), y = this.connect, x = [], u = [], A, z, B, D, C = this.chart.graphs.length, J,
                H = this.dx / this.tcc, S = this.dy / this.tcc, O = f.stackType, Q = this.start, ga = this.end, I = this.scrollbar,
                aa = "graph-column-";
            I && (aa = "scrollbar-graph-column-");
            var va = this.categoryAxis, ma = this.baseCoord, Oa = this.negativeBase, Z = this.columnIndex, da = this.lineThickness,
                X = this.lineAlpha, Aa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba, ha = this.getGradRotation(),
                T = this.chart.columnSpacing, Y = va.cellWidth, Da = (Y * k - r) / r;
            T > Da && (T = Da);
            var G, w, na, ia = q, Pa = n, ca = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Qa = this.negativeFillColors,
                Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
            ...
            for (L = Q; L <= ga; L++) {
                ...
                var R, P, K, ba, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN, wa = NaN, Ea = NaN, ka = NaN,
                    la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Ma = wb, Va = Ya, Ga = Aa, Ca, xa, Bb = this.proCandlesticks,
                    mb = this.topRadius, Fa = q - 1, oa = n - 1, bb = this.pattern;
                        ...
                        case"ohlc":
                            if (!(isNaN(ta) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                                ...
                                if (t) {
                                    ...
                                    if (0 === E && 0 === N && 0 === pa && 0 === ra) continue;
                                    if (E == oa && N == oa && pa == oa && ra == oa) continue;
                                    var Hb = F - k / 2, Hb = d.fitToBounds(Hb, 0, q), Tb = d.fitToBounds(F, 0, q), Ib = F + k / 2,
                                    ...
                                    "high" == l && (la = sa);
                                    "low" == l && (la = qa);
                                    var ka = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa, 0, Fa), Jb = E - k / 2,
                                        Jb = d.fitToBounds(Jb, 0, n), Ub = d.fitToBounds(E, 0, n), Kb = E + k / 2, Kb = d.fitToBounds(Kb, 0, n);
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR,
                    r = this.negativeLineColor, v = this.negativeFillColors, y = this.negativeFillAlphas, x = this.baseCoord,
        ...
        construct: function (a) {
            ...
            if (!this.pan) {
                ...
                if (b && 3 < Math.abs(b.width) && 3 < Math.abs(b.height)) {
                    var c = Math.min(this.index, this.index0), e = Math.max(this.index, this.index0), d = c, f = e, g = this.chart, k = g.chartData,
                        l = g.categoryAxis;
            ...
            if (this.mouseIsDown) {
                var a = d.roundTo((this.mouseX - this.mouseX0) / this.width,
                    3), b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width, 3),
    ...
    d.ChartScrollbar = d.Class({
        inherits: d.SimpleChartScrollbar, construct: function (a) {
            ...
            if (a.enabled) {
                ...
                var b = a.chart, c = b.chartData, e = a.categoryAxis, h = a.rotate, f = a.x, g = a.y, k = a.width, l = a.height, m = a.gridAxis,
                    n = a.set;
                e.setOrientation(!h);
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, v = this.verticalPadding, y = this.pointerWidth, x = this.pointerOrientation,
                        u = this.cornerRadius, A = c.fontFamily, z = this.fontSize;
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = z + v, m = D + r, O = this.shadowAlpha, Q = this.shadowColor, r = this.borderThickness, ga = this.bulletSize, I,
                        v = this.fillAlpha, aa = this.borderAlpha;
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate,
                q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, v = a.finalXValue, y = a.initialValue, x = a.finalValue,
                u = p.recalculateToPercents, A = b.dataDateFormat;
...
(function () {
    ...
    d.drop = function (a, b, c, d, h, f, g, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, p = Math.sin((m + 40) * l) * b,
            t = Math.cos((m + 40) * l) * b, r = .8 * b, v = -b / 3, y = b / 3;
        0 === c && (v = -v, y = 0);
        180 == c && (y = 0);
        90 == c && (v = 0);
        270 == c && (v = 0, y = -y);
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        359.94 < x && (x = 359.94);
        h >= x && (h = x);
        var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * v, z = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * g,
            D = b + Math.sin((e + h) * u) * f, C = c - Math.cos((e + h) * u) * g, J = b + Math.sin((e + h) * u) * k,
            u = c - Math.cos((e + h) * u) * v, H = {
...
(function () {
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n) {
            ...
            var h = Math.round, f = this.getPointOnSegment(a, b, .75), g = this.getPointOnSegment(d, c, .75), k = (d.x - a.x) / 16,
                l = (d.y - a.y) / 16, m = this.getPointOnSegment(a,
                b, .375);
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft +
                this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap, g = this.div,
                k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, t = 0, r = this.container;
