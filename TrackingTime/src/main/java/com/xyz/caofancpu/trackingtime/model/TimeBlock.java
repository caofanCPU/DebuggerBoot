...
public class TimeBlock {
    ...
    @ApiModelProperty(value = "主键Id", example = "98789")
    private Long id;

    @ApiModelProperty(value = "用户ID", example = "15928")
    private Long userId;

    @ApiModelProperty(value = "起始时间", example = "2019-08-12 12:11:10")
    private LocalDateTime startTime;

    @ApiModelProperty(value = "结束时间", example = "2019-08-12 13:14:15")
    ...
    @ApiModelProperty(value = "状态", example = "98789")
