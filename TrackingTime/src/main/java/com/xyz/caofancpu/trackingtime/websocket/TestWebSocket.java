package com.xyz.caofancpu.trackingtime.websocket;
...
public class TestWebSocket {
    ...
    public void onOpen(@PathParam(value = "uniqueId") Long uniqueId, Session session) {
        ...
        addOnlineCount();
        log.info("uniqueId={}加入, 当前连接数: {}", uniqueId, getOnlineCount());
    ...
    public void onClose(@PathParam(value = "uniqueId") Long uniqueId) {
        ...
        subOnlineCount();
        log.info("客户端uniqueId={}连接关闭, 当前连接数: {}", uniqueId, getOnlineCount());
    }
    ...
    public void onError(@PathParam(value = "uniqueId") Long uniqueId, Session session, Throwable error) {
        log.error("客户端uniqueId={}连接发生错误!, 原因: {}", uniqueId, error.getMessage());
    }
