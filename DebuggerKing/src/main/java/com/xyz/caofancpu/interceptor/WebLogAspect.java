...
public class WebLogAspect {
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        Map<String, Object> filteredFileValueMap = StreamUtil.removeSpecifiedElement(originRequestParamMap, new Class[]{MultipartFile.class, File.class});
    ...
    public void doAfterThrowingAdvice(JoinPoint joinPoint, Throwable ex) {
        log.warn("后台接口[{}]抛出异常:{}", getInterfaceFullName(joinPoint), ex.getMessage());
    }
