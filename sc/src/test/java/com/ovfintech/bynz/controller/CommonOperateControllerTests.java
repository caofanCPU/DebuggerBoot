...
import com.bynz.utils.contants.RoleEnum;
import com.ovfintech.bynz.BynzWebScApplication;
import com.ovfintech.bynz.controller.util.TestUtil;
...
public class CommonOperateControllerTests {
    ...
    @Test
    public void listSysDictByPageTest() throws Exception {
    ...
    @Test
    public void bynzUtilTest() {
        System.out.print(RoleEnum.ROLE_BANK_01.getCode());
    }
