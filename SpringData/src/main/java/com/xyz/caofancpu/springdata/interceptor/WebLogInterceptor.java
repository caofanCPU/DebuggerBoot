...
import com.xyz.caofancpu.springdata.utils.DataReflactProcessUtil;
...
public class WebLogInterceptor {
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        String requestParam = JSONUtil.formatStandardJSON(JSONObject.toJSONString(DataReflactProcessUtil.getParameterMap(request)));
        String requestBody;
        try {
